...
export const symptomColumn: ColumnDef<Symptom>[] = [
    ...
    },
    {
        ...
        cell: ({ row }) => {
            ...
            const [title, setTitle] = useState<string>(symptom.symptom_name)
            const [description, setDescription] = useState<string>(symptom.symptom_char)
            const onClickDelete = async () => {
                try {
                    const cookieValue = document.cookie.split('; ')
                        ...
                        ?.split('=')[1];
                    toast.promise(
                        fetch(`${BASE_URL}/symptoms/${symptom.id}`, {
                            method: 'DELETE',
                            headers: {
                            ...
                            <form onSubmit={onSubmitEdit}>
                                ...
                                <div className="flex flex-col gap-4 py-4">
                                    ...
                                    <Input
                                        ...
                                        placeholder="Enter the title of the symptom"
                                    />
